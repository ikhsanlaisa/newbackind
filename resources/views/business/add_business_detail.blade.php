        ...
        <div class="col-lg">
            <div class="card mb-3">
                ...
                <div class="card-body" style="font-size: small">
                    <form method="POST" action="{{route ('insertBusiness',['id'=>$menu->id_menu])}}"
                        ...
                        <div class="form-group col-lg-12" style="font-size: small">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="row form-group {{ $errors->has('Business name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-7">
                                            <input style="font-size: small" id="name" type="text" class="form-control"
                                                   name="name" value="{{ old('name') }}"
                                                   placeholder="Masukkan nama bisnis anda" required autofocus>
                                            @if ($errors->has('name'))
                          ...
                          <strong>{{ $errors->first('name') }}</strong>
                                    ...
                                    <div class="row form-group {{ $errors->has('Business email') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-7">
                                            <input style="font-size: small" id="email" type="email" class="form-control"
                                                   name="email" value="{{ old('email') }}"
                                                   placeholder="Masukkan email bisnis anda" required>
                          ...
                          <strong>{{ $errors->first('email') }}</strong>
                                    ...
                                    <div class="form-group gllpLatlonPicker">
                                        <div class="row form-group {{ $errors->has('Business address') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-lg-7">
                                                <input style="font-size: small" type="text"
                                                       class="form-control gllpSearchField" name="address"
                                        ...
                                        <div class="row form-group {{ $errors->has('Business address') ? ' has-error' : '' }}">
                                            <div class="col-lg-12">
                                                <div class="gllpMap col-lg-11" style="font-size:small">Google Maps</div>
                                    ...
                                    <div class="row form-group {{ $errors->has('Business lang') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-7">
                                            <input readonly style="font-size: small" type="text" id="lngShow"
                                                   name="lang" class="gllpLongitude form-control"
                                ...
                                <div class="col-lg-6">
                                    <div class="row form-group {{ $errors->has('Business phone') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-7">
                                            <input style="font-size: small" id="phone_number" type="number"
                                                   class="form-control" name="phone" value="{{ old('phone_number') }}"
                                                   placeholder="Masukkan no telefon bisnis anda " required autofocus>
                                            @if ($errors->has('phone'))
                                                <span class="help-block">
                          <strong>{{ $errors->first('phone') }}</strong>
                                    ...
                                    <div class="row form-group {{ $errors->has('Business open') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-7">
                                            <input style="font-size: small" id="open" type="time" class="form-control"
                                                   name="open" value="" placeholder="Waktu Operasional" required
                                                   autofocus>
                                        </div>
                                    </div>
                                    <div class="row form-group {{ $errors->has('Business close') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-7">
                                            <input style="font-size: small" id="close" type="time" class="form-control"
                                                   name="close" value="" placeholder="Waktu Operasional" required
                                                   autofocus>
                                        </div>
                                    </div>
                                    <div class="row form-group {{ $errors->has('Range price') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-7">
                                            <input style="font-size: small" id="price" type="number"
                                                   class="form-control" name="price" value=""
                                                   placeholder="(IDR) rentang harga tiket" required autofocus>
                                            @if ($errors->has('price'))
                                                <span class="help-block">
                          <strong>{{ $errors->first('price') }}</strong>
                                    ...
                                    <div class="row form-group {{ $errors->has('Business status') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea rows="13" style="font-size: small" id="desc" type="text"
                                                      class="form-control" name="desc" value=""
                                                      placeholder="Masukkan Deskripsi Bisnis ( maksimal 500 huruf )"
                            ...
                            <div class="row form-group {{ $errors->has('Business address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-11">
                                    <label style="color:#9e9e9e">
                                        ...
                                        benar, maka kami siap menerima konsekuensi pembatalan sebagai mitra usaha
                                        startup Backind.
                                    </label>
                                </div>
                            </div>
